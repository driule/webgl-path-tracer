...
(function (LH) {
    var PathTracer = /** @class */ (function () {
        ...
        PathTracer.prototype.setObjects = function (triangles, lights) {
...
(function (LH) {
    var Renderer = /** @class */ (function () {
        ...
        Renderer.prototype.start = function () {
            ...
            var lights = [
                new LH.Light([20.25, 22.75, 0.25], 1.5, 50.0),
                new LH.Light([0.0, 5.75, 20.25], 0.25, 1550.0),
                new LH.Light([-20.25, 20.75, 0.25], 0.15, 75.0)
            ];
